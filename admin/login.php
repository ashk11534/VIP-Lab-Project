...
<?php
    ...
    if(isset($_SESSION['login-failed'])){
        ?>
        <p class="text-center font-weight-bold vanish" style="color: #ff4757; background: #fff; padding: 2px; margin-top:10px; width: 19.5%; margin-left: auto; margin-right: auto; border-radius: 4px;"><?php echo $_SESSION['login-failed']; ?></p>
        <?php
